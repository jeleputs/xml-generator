  ...
  return new function() {
    ...
    function createObjTree(oParentNode, nVerb, bFreeze, bNesteAttr) {
      var CDATA = 4,
        ...
        vResult = bHighVerb
          ? {}
          : /* put here the default value for empty nodes: */ opts.trueIsEmpty
          ? true
          : '',
        sProp,
        vContent;
    ...
    function loadObjTree(oXMLDoc, oParentEl, oParentObj) {
      ...
      for (var sName in oParentObj) {
        ...
        if (sName === opts.valueKey) {
          ...
          elementNS =
            (vValue || {})[opts.attrPrefix + 'xmlns'] || oParentEl.namespaceURI;
          if (elementNS) {
            oChild = oXMLDoc.createElementNS(elementNS, sName);
          } else {
            oChild = oXMLDoc.createElement(sName);
    ...
    this.jsToXml = this.unbuild = function(
      oObjTree,
      sNamespaceURI /* optional */,
      sQualifiedName /* optional */,
      oDocumentType /* optional */
    ) {
